...
- Added focused contractor dashboard confidence summaries so each tool page shows current private record counts, attention counts, and how to verify saved records before create panels.
