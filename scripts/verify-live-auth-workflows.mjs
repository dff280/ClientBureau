...
const accounts = [
  {
    ...
    routes: ["/dashboard", "/dashboard/reports", "/dashboard/contracts", "/dashboard/recovery", "/dashboard/evidence"],
  },
  {
    kind: "admin",
    ...
    expectedRole: "admin",
    routes: ["/admin", "/admin/reports", "/admin/clients", "/admin/recovery", "/admin/contracts"],
  },
]
