...
export const contractPackets: ContractPacket[] = [
  {
    ...
    nextAction: "Archive signed packet with completion and invoice records.",
    shareToken: "maria-alvarez-deck-maintenance-contract-packet-01",
    shareUrl: "/contract/maria-alvarez-deck-maintenance-contract-packet-01",
  ...
  },
  {
    ...
    shareUrl: "/contract/new-intake-client-roof-repair-contract-packet-02",
...
export const adminSavedViews: AdminSavedView[] = [
  ...
  },
  {
    id: "saved_view_03",
    scope: "contracts",
    name: "Packets before scheduling",
...
export const recoveryComplianceReviews: RecoveryComplianceReview[] = [
  ...
  },
  {
    ...
    requiredChanges: ["Confirm deadline", "Confirm delivery method", "Attach contract packet"],
    publicVisibilityAllowed: false,
    createdAt: "2026-05-31T12:00:00.000Z",
    updatedAt: "2026-05-31T12:00:00.000Z",
  },
