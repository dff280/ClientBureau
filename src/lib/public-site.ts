...
export const publicDatabasePillars: PublicDatabasePillar[] = [
  {
    ...
    href: "/clients",
    cta: "Open Client Database",
    tone: "client",
    proofPoints: ["Client checks", "Moderated experiences", "Response rights"],
  ...
  },
  {
    ...
    cta: "Open Contractor Database",
    tone: "contractor",
    proofPoints: ["Business trust", "Verification signals", "Service readiness"],
  ...
  },
  {
    ...
    href: "/profiles/subcontractor",
    cta: "Open Subcontractor Database",
    tone: "subcontractor",
    proofPoints: ["Trade scope", "GC/sub context", "Payment-chain signals"],
