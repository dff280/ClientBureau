...
export function simulateSubmittedClientReport(input: SimulatedClientReportInput): ClientReport {
  ...
  return {
    ...
    reportedBusinessRole: input.reportedBusinessRole,
    counterpartyBusinessRole: input.counterpartyBusinessRole,
    hiringPartyNamePrivate: input.hiringPartyNamePrivate,
    scopeDocumentationStatus: input.scopeDocumentationStatus,
    workAuthorizationStatus: input.workAuthorizationStatus,
    retainageAmount: input.retainageAmount,
    paymentApplicationReference: input.paymentApplicationReference,
    licenseInsuranceContext: input.licenseInsuranceContext,
    relationshipVerificationSummary: input.relationshipVerificationSummary,
    tradeCategory: input.tradeCategory,
